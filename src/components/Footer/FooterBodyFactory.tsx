/**
 * FooterBodyFactory - Creates the actual footer content based on footer kind
 * This is the DRY equivalent of the individual footer components
 */
 ...
 */
const FooterBodyFactory: React.FC<
...
export default FooterBodyFactory;
