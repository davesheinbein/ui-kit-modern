 ...
 */
const Monetization = forwardRef<HTMLDivElement, MonetizationProps>(
	({ children, ...props }, ref) => {
		...
		if (children) {
			return (
				<div ref={ref} className={props.className} id={props.id} data-testid={props['data-testid'] || props.testId}>
					{children}
				</div>
			);
		}
		
		return <UnifiedMonetization ref={ref} {...unifiedProps} />;
	}
);
