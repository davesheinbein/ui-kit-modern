...
// ===== CLOSE BUTTON POSITION TESTS =====

export const CloseButtonPositions: Story = {
	args: {
		count: 'many',
		layout: 'grid',
		ads: [
			{
				kind: 'banner',
				content: {
					title: 'Close: Top Right (Default)',
					description: 'Close button in top-right corner',
					ctaText: 'Test Close',
					imageUrl: sampleImage,
				},
				style: {
			...
			},
			{
				...
				content: {
					...
					description: 'Close button in top-left corner',
					ctaText: 'Test Close',
					imageUrl: sampleImage,
				},
				style: {
			...
			},
			{
				kind: 'banner',
				content: {
					title: 'Close: Bottom Left',
					description: 'Close button in bottom-left corner',
					ctaText: 'Test Close',
					imageUrl: sampleImage,
				},
				style: {
	...
	parameters: {
		docs: {
			description: {
				story:
					'Test all close button positions. Each ad can be closed by clicking the X button in different corners. When closed, the ad should disappear and not redirect to any URL.',
			},
		},
	},
};
