...
const defaultGridStyle = {
	backgroundColor: '#F8F6F0', // eggshell white
	borderRadius: 12,
	padding: 12,
...
// === GRID STORIES ===
export const Grid3x3 = (args: GridProps) => (
	<Grid
		{...args}
		kind='grid'
		words={gridWords3x3}
...
export const Grid4x4 = (args: GridProps) => (
	<Grid
		{...args}
		kind='grid'
		words={gridWords4x4}
...
export const Grid5x5 = (args: GridProps) => (
	<Grid
		{...args}
		kind='grid'
		words={gridWords5x5}
...
// === PREGAME STORIES ===
export const Pregame3x3 = (args: GridProps) => (
	<Grid
		{...args}
		kind='pregame'
		words={gridWords3x3}
...
export const Pregame4x4 = (args: GridProps) => (
	<Grid
		{...args}
		kind='pregame'
		words={gridWords4x4}
...
export const Pregame5x5 = (args: GridProps) => (
	<Grid
		{...args}
		kind='pregame'
		words={gridWords5x5}
...
// === SOLVED STORIES ===
export const Solved3x3 = (args: GridProps) => (
	<Grid
		{...args}
		kind='solved'
		pendingSolvedGroups={[
...
export const Solved4x4 = (args: GridProps) => (
	<Grid
		{...args}
		kind='solved'
		pendingSolvedGroups={[
...
export const Solved5x5 = (args: GridProps) => (
	<Grid
		{...args}
		kind='solved'
		pendingSolvedGroups={[
